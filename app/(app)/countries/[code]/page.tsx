...
export default async function CountryPage({
  ...
  // 10.7's role check is gone with the roles (0006_drop_roles.sql): every
  // authenticated user may open any country dashboard. The `isCountryCode`
  // guard above is still what keeps an unknown code from reaching the queries.
